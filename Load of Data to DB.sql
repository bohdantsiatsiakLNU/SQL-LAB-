...
(2, 'Moon', 'Kyiv', 'Shevchenka', 15),
(3, 'Saturn', 'Lviv', 'Zelena', 210),
(4, 'Mars', 'Rivne', 'Verbova', 57),
(5, 'Mercury', 'Ternopil', 'Hrushevskoho', 34),
(6, 'Pluton', 'Kyiv', 'Khreshchatyk', 128);

/* 
    (5, 'Mercury', 'Ternopil', NULL, 34),
    -- у цьому рядку повинна бути присутня вулиця, оскільки це обов'язкове поле
    
    (6, 'Pluton', 'Kiyv', 'Chreschtschatyk', 128);
    -- неправильна транслітерація слів 'Kiyv' та 'Chreschtschatyk'
*/
...
(1,'LyubomyrMartynenko','Lyubomyr','Martynenko','CEO','1998-01-01',1,1,10000,NULL),
(2,'LinaSirenko','Lina','Sirenko','Financial Analyst','2016-08-20',1,1,8500,NULL),
...
(14,'ArturZayika','Artur','Zayika','Manager','1999-07-20',1,1,7000,NULL),
...
(38,'ViktorKovalov','Viktor','Kovalov','Seller','2002-12-19',3,11,3500,175),
...
(47,'LidiyaZayika','Lidiya','Zayika','Senior Consultant','2015-03-11',5,14,5500,NULL),
(48,'NadiyaSavenko','Nadiya','Savenko','Consultant','2017-09-13',5,14,4500,NULL),
(49,'AlinaOsadchuk','Alina','Osadchuk','Assistant Consultant','2014-01-05',5,14,4000,NULL),
(50,'DenysKobzar','Denys','Kobzar','Seller','2016-10-17',5,14,3500,NULL);
...
-- в цих рядках заповнив NULL в обов'язкових полях, а також змінив user_name для 21 з 'ViktorKovalov' на 'ViktorDemchuk'
*/
...
(29,'ASUS B5602CBN-OLED-UI74D0X','ASUS EXPERTBOOK B5 - I7 1260P 24GB 1TB_SSD ARC A350M 16'' OLED WQUXGA GLOSSY WIN 11 PRO BLACK BACKL','NOTEBOOK','ASUS','Devices',29,1503.07),
(35,'LENOVO YOGA 7 14 / 82QF003QBM','LENOVO R7-6 32G INT 1TB SSD 14'' 2.8K OLED IPS GL WIN11 HOME GRAY TOUCH','NOTEBOOK','LENOVO','Devices',19,1439.82)
-- у цих рядках потрібно в описі продукта замінити одинарні лапки '' на "
*/
...
ALTER TABLE invoice
MODIFY COLUMN transaction_moment DATETIME NOT NULL;
...
('20220912081145',24,49,2, '2022-09-12 08:11:45',4),
...
('20230922111120',43,43,1, '2023-09-23 11:56:01',3),
...
/*
('20221014112444',20,71,3, '2022-10-14-11:24:44',2),
-- у даному рядку потрібно видалити "-" між датою та часом 

('20230922111119',35,3,3, '2023-09-22 11:11:19',4),
('20230922111119',43,43,1, '2023-09-23 11:56:01',3),
-- повторюються первинні ключі замінив другий на '20230922111120'
*/
...
(975,'20230922111119',28,'2023-09-23 11:56:01',1),
(976,'20230924114050',57,'2023-09-23 14:23:02',4),
(977,'20230924114050',15,'2023-09-23 15:05:21',3),
...
ALTER TABLE emp
MODIFY COLUMN invoice_id VARCHAR(50);

INSERT INTO emp (emp_id, invoice_id, product_id, order_datetime, quantity) VALUES
(1,'20220902081028',107,'2022-09-02 08:10:28',5),
(2,'20220902081028',78,'2022-09-02 11:01:44',1),
(3,'20220902081028',42,'2022-09-02 14:18:33',1),
(4,'20220902081028',73,'2022-09-02 16:46:07',2),
...
FROM emp t1
LEFT JOIN invoice t2 ON t1.invoice_id = t2.invoice_id
